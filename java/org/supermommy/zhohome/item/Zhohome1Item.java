...
public class Zhohome1Item extends Item {
	@ObjectHolder("zhohome:zhohome_1")
	public static final Item block = null;

	public Zhohome1Item() {
		super(new Item.Properties().group(ZhoworldItemGroup.tab).maxDamage(64));
	}
	...
	public ActionResultType onItemUse(ItemUseContext context) {
		...
		if (!entity.canPlayerEdit(pos, context.getFace(), itemstack)) {
			...
			if (world.isAirBlock(pos) && true) {
				Zhohome1Dimension.portal.portalSpawn(world, pos);
