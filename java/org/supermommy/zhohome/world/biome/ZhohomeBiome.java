...
package org.supermommy.zhohome.world.biome;

import org.supermommy.zhohome.entity.Zhohome3Entity;
import org.supermommy.zhohome.entity.JiniuEntity;
...
public class ZhohomeBiome extends ZhohomeModElements.ModElement {
	public static Biome biome;

	public ZhohomeBiome(ZhohomeModElements instance) {
		super(instance, 6);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(ZhoblockBlock.block.getDefaultState(),
				...
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(Zhohome3Entity.entity, 20, 4, 4));
				mobSpawnInfo.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(JiniuEntity.entity, 20, 2, 2));
				biome = new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.NONE).depth(0.1f).scale(0.2f).temperature(0.5f)
						.downfall(0.5f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("zhohome:zhohome"));
			}
		}
	}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("zhohome_ctd");
