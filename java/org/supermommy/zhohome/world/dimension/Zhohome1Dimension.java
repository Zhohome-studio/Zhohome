...
package org.supermommy.zhohome.world.dimension;

import org.supermommy.zhohome.item.Zhohome1Item;
import org.supermommy.zhohome.block.ZhoblockBlock;
...
public class Zhohome1Dimension extends ZhohomeModElements.ModElement {
	@ObjectHolder("zhohome:zhohome_1_portal")
	public static final CustomPortalBlock portal = null;

	public Zhohome1Dimension(ZhohomeModElements instance) {
		super(instance, 7);
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(ZhoblockBlock.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("zhohome:zhohome")).getGenerationSettings().getSurfaceBuilder()
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("zhohome:zhohome_1"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("zhohome_1_portal", Vector3i::compareTo, 300);
	...
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("zhohome_1_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1)
					.setRegistryName("zhohome_1_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new Zhohome1Item().setRegistryName("zhohome_1"));
	}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("zhohome:zhohome_1"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("zhohome:zhohome_1")));
				} else {
					entity.func_242279_ag();
				...
				for (int l1 = -1; l1 < 2; ++l1) {
					for (int k2 = 0; k2 < 2; ++k2) {
						for (int i3 = -1; i3 < 3; ++i3) {
							BlockState blockstate1 = i3 < 0 ? Blocks.REDSTONE_BLOCK.getDefaultState() : Blocks.AIR.getDefaultState();
			...
			for (int k1 = -1; k1 < 3; ++k1) {
				for (int i2 = -1; i2 < 4; ++i2) {
					if (k1 == -1 || k1 == 2 || i2 == -1 || i2 == 3) {
						...
						this.world.setBlockState(blockpos$mutable, Blocks.REDSTONE_BLOCK.getDefaultState(), 3);
					}
				}
			}
